...
const getParameters = () => {
    ...
    if (url.searchParams.get("doclink") == null) {
        document.querySelector(".alert").style.animation = "comeup .5s cubic-bezier(0.23, 1, 0.320, 1) forwards";
...
document.querySelector("#close").addEventListener("click", () => {
    ...
    document.querySelector(".alert").style.animation = "comeup .5s backwards";
});
